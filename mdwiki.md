...
The general workflow recommended for using MDWiki is to set it up on [Github Pages](Github%20Pages.md), using Github's built-in hosting to view your personal wiki, while also tracking all changes in the repository. You can then use stackedit.io to edit the markdown files, though I personally use Notepad++ with the NPPMarkdownPanel plugin.
